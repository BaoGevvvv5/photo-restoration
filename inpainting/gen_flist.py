...
parser.add_argument('--folder_path',default='/home/baoge/dataset',type=str,help='The folder path')
parser.add_argument("--train_filename",default='./edgeconnect/project/datasets/places_train.flist',type=str,help='The train filename')
parser.add_argument('--validation_filename', default='./edgeconnect/project/datasets/places_val.flist', type=str,help='The validation filename.')
...
if __name__ == "__main__":
    ...
    print("size of places2 is %d" % (len(photo_filenames)))
